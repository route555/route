...
var view = {		
		...
		$("#btnTrAcctPop").click( function() {
			...
			window.open(G_CONTEXT_PATH+"/web/tracctmgt/tracctpop?trAcctCd=''&srchType=T&srchChgSectCd=", "window", "width=1200,height=800,scrollbars=yes");
		...
		$("#btnSalesChgr").click( function() {
			...
			window.open(G_CONTEXT_PATH+"/web/tracctmgt/tracctpop?trAcctCd="+$("#trAcctCd").val()+"&srchType=S&srchChgSectCd=002", "window", "width=1200,height=800,scrollbars=yes");
		...
		$("#btnCalChgr").click( function() {
			...
			window.open(G_CONTEXT_PATH+"/web/tracctmgt/tracctpop?trAcctCd="+$("#trAcctCd").val()+"&srchType=C&srchChgSectCd=004", "window", "width=1200,height=800,scrollbars=yes");
